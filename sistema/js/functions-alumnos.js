...
document.addEventListener('DOMContentLoaded',function(){
    ...
    formALumnos.onsubmit = function(e) {
        ...
        var ajaxUrl = idAlumno === '' ? './models/alumnos/ajax-alumno-registrar.php'
                                      : './models/alumnos/ajax-alumno-editar.php';
        ...
        btnEditAlumno.addEventListener('click',function(){
            ...
            request.onreadystatechange = function() {
                if(request.readyState == 4 && request.status == 200) {
                    if(request.status) {
                        var objData = JSON.parse(request.responseText);
                        document.querySelector('#idAlumno').value = objData.data.id_solicitante;
                        ...
                        document.querySelector('#fechaNac').value = objData.data.fecha_nacimiento;
